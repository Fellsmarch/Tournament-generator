...
public class TournamentGUI {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					TournamentGUI window = new TournamentGUI();
	...
	private void initialize() {
		...
		frame.getContentPane().add(firstView, "name_91076667292694");
		firstView.setLayout(null);
		
		JPanel groupStage = new JPanel();
		frame.getContentPane().add(groupStage, "name_91081161188168");
		groupStage.setLayout(null);
		
		JLabel lblTestLabel = new JLabel("Test Label");
		lblTestLabel.setBounds(21, 21, 171, 26);
		firstView.add(lblTestLabel);
		
		JButton btnSwitchScreens = new JButton("Switch Screens");
		btnSwitchScreens.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				firstView.setVisible(false);
				groupStage.setVisible(true);
			}
		});
		btnSwitchScreens.setBounds(151, 17, 141, 35);
		firstView.add(btnSwitchScreens);
		

		//Group stage
		lblHowManyGroups = new JLabel("How many groups do you want?");
		lblHowManyGroups.setBounds(12, 12, 241, 15);
		groupStage.add(lblHowManyGroups);
		...
		groupStage.add(enterNumOfTeams);
		...
		groupStage.add(buttonEnterTeamName);
		...
		groupStage.add(namesListOutput);
		...
		groupStage.add(buttonRemoveLast);
